...
| Repository README | `README.md` | `RECORDED` | README updated on 2026-05-12 with current status, layout, final VP8b result table, common commands, and tracking rules | Documentation-only update; no EDA tool rerun; technical caveats unchanged |
